# 🚀 Actions à réaliser après le déploiement
...
- [ ] Soumettre le sitemap.xml : `https://www.albertin-chirurgien.com/sitemap.xml`
- [ ] Vérifier l'indexation des pages
- [ ] Demander une indexation rapide pour les pages principales
...
- [ ] Compléter toutes les informations :
  - Nom : Dr Jérôme ALBERTIN - Chirurgien Vasculaire
  - Catégorie : Chirurgien vasculaire
  - Adresses exactes
  - Numéros de téléphone
  - Horaires de consultation
  - Site web : https://www.albertin-chirurgien.com
- [ ] Ajouter des photos (façade, salle d'attente, bureau)
- [ ] Ajouter des attributs (parking, accessibilité PMR, etc.)
...
- [ ] Annuaire Santé Ameli : https://annuairesante.ameli.fr
- [ ] Allo-Médecins
- [ ] Kelest.fr
- [ ] Médecins d'ici
...
- [ ] Créer du contenu vidéo explicatif
...
- [ ] Créer du contenu local (Draguignan, Fréjus, Var)
...
- "chirurgie vasculaire 83"
- "anévrisme aorte Draguignan"
- etc.
...
- **CTR (Click-Through Rate)** : % de clics par rapport aux impressions
- **Profil Google My Business** : vues, appels, demandes d'itinéraire
...
- [ ] 25+ avis Google
- [ ] Top 3 sur "chirurgien vasculaire Draguignan"
...
- **Ubersuggest** : recherche de mots-clés (limité)
...
1. **Patience** : Le SEO prend 3-6 mois pour des résultats significatifs
2. **Qualité** : Privilégier le contenu de qualité aux techniques "black hat"
3. **Régularité** : Publier du contenu régulièrement (1-2x/mois minimum)
4. **Avis clients** : Encourager les patients satisfaits à laisser un avis Google
5. **Local first** : Se concentrer sur le SEO local (Draguignan, Fréjus, Var)
6. **Mobile** : 70% des recherches se font sur mobile
7. **E-E-A-T** : Google valorise l'Expertise, l'Expérience, l'Autorité et la Confiance
